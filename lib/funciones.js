...
function detalle(codigo, operacion){
	jQuery.get("http://"+dirIP+":"+puerto+"/t_inm_inmueble_0002_consulta_busqueda_inmueble",{"TK":"123456","tipo_operacion":operacion,"inm_inmueble_sec":codigo},function(resultado){
		...
		$.each(miRes10,function(i, elemento){			
			...
			$.each(miRes12,function(i, elemento){
				...
				jQuery.get("http://"+dirIP+":"+puerto+"/t_inm_inmueble_fotos_0001_consulta_fotos",{"TK":"123456","inm_inmueble_sec":codigo},function(resultado){
